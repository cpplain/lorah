...
- **Port:** Only launch on port {frontend_port}
...
- **Claude API:** Integration with Claude API using Anthropic SDK
...
### 1. Setup Project Foundation and Database
